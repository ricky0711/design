                ...
                <form action="#" method="post">
                  <div class="section-field mb-20">
                    ...
                    title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"
                     type="password" placeholder="Password" name="old_pswd" required>
                  ...
                  <div class="section-field mb-20">
                    ...
                    <input id="confirm2" class="Password form-control" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
                    title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"
                     type="password" placeholder="Re-Type Password" name="rpswd" onkeyup="checkPass();" required>
